...
```bash
agentcad precheck fan_duct_adapter_v2     # 1. solve design.json statically
# write part.py once precheck is green
agentcad build fan_duct_adapter_v2        # 2. generate STEP/STL
agentcad measure fan_duct_adapter_v2      # 3. measure geometry stats
agentcad validate fan_duct_adapter_v2     # 4. run all checks (auto-renders SVGs)
agentcad review fan_duct_adapter_v2       # 5. pre-delivery checklist + relations matrix
agentcad deliver fan_duct_adapter_v2      # 6. write delivery manifest
```
