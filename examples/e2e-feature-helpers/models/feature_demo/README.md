...
```bash
agentcad precheck feature_demo     # 1. solve design.json statically
# write part.py once precheck is green
agentcad build feature_demo        # 2. generate STEP/STL
agentcad measure feature_demo      # 3. measure geometry stats
agentcad validate feature_demo     # 4. run all checks (auto-renders SVGs)
agentcad review feature_demo       # 5. pre-delivery checklist + relations matrix
agentcad deliver feature_demo      # 6. write delivery manifest
```
