...
`expected: [width, depth]` → the measured section or regional section bounding
box must match those dimensions within `tolerance`.

Use dimension mode for rectangular arms, lips, ribs, shelves, and other
non-circular features where merely proving "some material exists" is too weak:
